...
let ExerciseController = class ExerciseController {
    ...
    start(req, dto) {
        return this.exerciseService.startExercise(req.user.user_id, dto);
    }
    end(req) {
        return this.exerciseService.endExercise(req.user.user_id);
    }
};
...
], ExerciseController.prototype, "start", null);
__decorate([
    (0, common_1.Post)('end'),
    ...
    __metadata("design:returntype", void 0)
], ExerciseController.prototype, "end", null);
