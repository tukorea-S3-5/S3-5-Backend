...
--
-- Host: localhost    Database: momfit
-- ------------------------------------------------------
...
CREATE TABLE `exercise` (
  ...
  `position_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fall_risk` tinyint NOT NULL DEFAULT '0',
...
-- Dump completed on 2026-02-26  2:05:46
